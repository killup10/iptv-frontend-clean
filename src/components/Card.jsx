...
import { isAndroidTV } from '../utils/platformUtils.js';
  ...
  {typeof progressPercent === 'number' && progressPercent > 0 && progressPercent < 100 && (
        ...
        {ratingDisplay && (
          <div className="absolute top-2 left-2 bg-black/80 text-yellow-400 text-xs px-2 py-1 rounded-md font-semibold z-30 flex items-center gap-1 pointer-events-none">
...
// Memoizar para evitar re-renders innecesarios cuando los props no cambian
