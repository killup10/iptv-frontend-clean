...
function Carousel({
  ...
  return (
    <section
      className={isClassicVariant ? 'media-row-container mb-3 md:mb-6 lg:mb-8' : 'media-row-container relative mb-4 md:mb-8 lg:mb-10'}
      ...
      <div className={isClassicVariant ? '' : 'relative rounded-[28px] border border-fuchsia-300/10 bg-[linear-gradient(135deg,rgba(35,8,67,0.18),rgba(8,8,25,0.22)_58%,rgba(2,17,35,0.18))] px-0 py-3 shadow-[0_18px_44px_rgba(46,16,101,0.18)] backdrop-blur-[2px] sm:px-1'}>
        ...
        <div
          ...
          className={isClassicVariant
            ? 'flex overflow-x-auto pb-4 pl-2 pr-2 hide-scrollbar mobile-touch-scroll sm:space-x-3 sm:pl-4 sm:pr-4 md:space-x-4 md:pl-1 md:pr-1 [&>*]:w-[130px] [&>*]:flex-shrink-0 sm:[&>*]:w-[145px] md:[&>*]:w-[165px] lg:[&>*]:w-[220px] xl:[&>*]:w-[240px]'
            : 'hide-scrollbar mobile-touch-scroll flex overflow-x-auto pb-4 pl-2 pr-2 sm:space-x-3 sm:pl-4 sm:pr-4 md:space-x-4 md:pl-4 md:pr-4 xl:space-x-5 2xl:space-x-6 [&>*]:w-[130px] [&>*]:flex-shrink-0 sm:[&>*]:w-[145px] md:[&>*]:w-[165px] lg:[&>*]:w-[230px] xl:[&>*]:w-[260px] 2xl:[&>*]:w-[280px]'}
          style={{
