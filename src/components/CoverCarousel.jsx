    ...
    <div className="w-full">
      ...
      <div className="relative w-full" style={{ aspectRatio: '21/9' }}>
        ...
        <div className="relative h-full flex items-center px-6 sm:px-12 lg:px-16">
          ...
          <button
            onClick={handlePrev}
            className="absolute left-4 sm:left-6 z-20 p-3 rounded-full bg-black/40 hover:bg-black/70 transition-colors duration-200"
          ...
          <div className="absolute left-0 bottom-0 w-full max-w-2xl px-6 sm:px-12 lg:px-16 pb-8 sm:pb-12 z-10 space-y-3">
            {/* Título */}
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white line-clamp-2">
            ...
            {currentItem?.description && (
              <p className="text-xs sm:text-sm text-gray-200 line-clamp-2 max-w-xl">
                {currentItem.description}
              </p>
            )}
            ...
            <div className="flex gap-3 flex-wrap pt-2">
              ...
              <button
                ...
                className="px-6 sm:px-8 py-2 sm:py-3 bg-cyan-600 hover:bg-cyan-700 text-white font-bold rounded-md transition-colors duration-200 flex items-center gap-2 text-sm sm:text-base shadow-lg"
                style={{
              ...
              {currentItem?.trailerUrl && (
                <button
                  ...
                  className="px-5 sm:px-7 py-2 sm:py-3 bg-white/20 hover:bg-white/30 text-white font-semibold rounded-md transition-colors duration-200 backdrop-blur-sm border border-white/30 text-sm sm:text-base"
                >
                  ▶ TRÁILER
                </button>
              )}
          ...
          <button
            onClick={handleNext}
            className="absolute right-4 sm:right-6 z-20 p-3 rounded-full bg-black/40 hover:bg-black/70 transition-colors duration-200"
